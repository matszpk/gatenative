...
#[test]
fn test_generate_code_wire_order() {
    let circuit = Circuit::new(
        3,
        [
            Gate::new_xor(0, 1),
...
"##
    ...
    generate_code_with_config_and_wire_order(
        ...
        true,
        CodeConfig::new()
            .input_placement(Some((&[6, 11, 44], 68)))
            .output_placement(Some((&[48, 72], 88))),
    );
    assert_eq!(
        String::from_utf8(cw_impl.out.clone()).unwrap(),
        r##"Func test1(3 2)
...
"##
    ...
    generate_code_with_config_and_wire_order(
        ...
        false,
        true,
        CodeConfig::new().arg_inputs(Some(&[0, 2])),
    );
    assert_eq!(
        String::from_utf8(cw_impl.out.clone()).unwrap(),
        r##"Func test1(3 2 2)
