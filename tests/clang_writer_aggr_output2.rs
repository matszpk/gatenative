...
"##
    ...
    v1 = _mm_load_ps((const float*)&input[2]);
    v2 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[0], v2);
    v3 = _mm_load_ps((const float*)&input[1]);
    v4 = _mm_load_ps((const float*)&input[3]);
    v5 = _mm_xor_ps(v3, v4);
    v0 = _mm_and_ps(v0, v1);
    v1 = _mm_xor_ps(v5, v0);
    ...
    v0 = _mm_or_ps(v0, v3);
    v3 = _mm_xor_ps(v7, v0);
    _mm_store_ps((float*)&output[2], v3);
    v4 = ((arg & 2) != 0) ? one : zero;
    v5 = ((arg & 8) != 0) ? one : zero;
    v4 = _mm_xor_ps(v4, v5);
    v0 = _mm_and_ps(v7, v0);
    ...
    v5 = _mm_load_ps((const float*)&input[4]);
    v9 = _mm_load_ps((const float*)&input[6]);
    v10 = _mm_xor_ps(v5, v9);
    v1 = _mm_or_ps(v8, v1);
    v6 = _mm_andnot_ps(v7, v6);
    v1 = _mm_andnot_ps(v6, v1);
    v6 = _mm_xor_ps(v10, v1);
    _mm_store_ps((float*)&output[6], v6);
    ...
    v1 = _mm_xor_ps(v6, v1);
    _mm_store_ps((float*)&output[7], v1);
#define o0 (v2)
#define o2 (v3)
#define o3 (v0)
#define o5 (v4)
...
"##
    ...
    __m256 v9;
    __m256 v10;
    v0 = _mm256_load_ps((const float*)&input[3]);
    v1 = _mm256_load_ps((const float*)&input[0]);
    v2 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[7], v2);
    v3 = _mm256_load_ps((const float*)&input[4]);
    v4 = _mm256_load_ps((const float*)&input[6]);
    v5 = _mm256_xor_ps(v3, v4);
    v0 = _mm256_and_ps(v0, v1);
    v1 = _mm256_xor_ps(v5, v0);
    _mm256_store_ps((float*)&output[5], v1);
    v1 = ((arg & 1) != 0) ? one : zero;
    v6 = ((arg & 4) != 0) ? one : zero;
    ...
    _mm256_store_ps((float*)&output[2], v3);
    v4 = ((arg & 2) != 0) ? one : zero;
    v5 = ((arg & 8) != 0) ? one : zero;
    ...
    _mm256_store_ps((float*)&output[6], v0);
    v1 = ((arg & 16) != 0) ? one : zero;
    v4 = ((arg & 64) != 0) ? one : zero;
    v5 = _mm256_xor_ps(v1, v4);
    _mm256_store_ps((float*)&output[3], v5);
    v6 = ((arg & 32) != 0) ? one : zero;
    v7 = ((arg & 128) != 0) ? one : zero;
...
#undef i12
#undef i13
    v8 = _mm_load_ps((const float*)&input[0]);
    v9 = _mm_load_ps((const float*)&input[2]);
    v10 = _mm_xor_ps(v8, v9);
    _mm_store_ps((float*)&output[0], v10);
    v11 = _mm_load_ps((const float*)&input[1]);
    v12 = _mm_xor_ps(v11, v2);
    v8 = _mm_and_ps(v8, v9);
    v9 = _mm_xor_ps(v12, v8);
    _mm_store_ps((float*)&output[1], v9);
    v9 = _mm_load_ps((const float*)&input[3]);
    v13 = _mm_xor_ps(v0, v9);
    v8 = _mm_and_ps(v12, v8);
    v2 = _mm_and_ps(v11, v2);
    v2 = _mm_or_ps(v8, v2);
    v8 = _mm_xor_ps(v13, v2);
    _mm_store_ps((float*)&output[2], v8);
    v1 = _mm_xor_ps(v1, v3);
    ...
    _mm_store_ps((float*)&output[3], v0);
    v1 = _mm_xor_ps(v4, v6);
    _mm_store_ps((float*)&output[4], v1);
    v2 = _mm_load_ps((const float*)&input[4]);
    v3 = _mm_xor_ps(v2, v7);
    ...
    v2 = _mm_xor_ps(v9, v1);
    _mm_store_ps((float*)&output[6], v2);
    v2 = _mm_load_ps((const float*)&input[5]);
...
#undef i10
    ...
    v5 = _mm_load_si128((const __m128i*)&input[3]);
    v8 = _mm_load_si128((const __m128i*)&input[7]);
...
#undef i6
#undef i10
    v4 = _mm256_load_si256((const __m256i*)&output[0]);
    v5 = elem_low_bit0;
    v6 = _mm256_xor_si256(v4, v5);
    v7 = _mm256_load_si256((const __m256i*)&output[2]);
    v8 = elem_low_bit1;
    v9 = _mm256_xor_si256(v7, v8);
    v4 = _mm256_and_si256(v4, v5);
    v5 = _mm256_xor_si256(v9, v4);
    v10 = _mm256_load_si256((const __m256i*)&output[5]);
    _mm256_store_si256((__m256i*)&output[5], v5);
    ...
    v8 = _mm256_load_si256((const __m256i*)&output[7]);
    _mm256_store_si256((__m256i*)&output[7], v7);
    v9 = elem_low_bit2;
    ...
    v1 = _mm256_load_si256((const __m256i*)&output[3]);
    _mm256_store_si256((__m256i*)&output[3], v0);
    v2 = elem_low_bit3;
    v4 = ((arg & 1) != 0) ? one : zero;
    v5 = _mm256_xor_si256(v2, v4);
    _mm256_store_si256((__m256i*)&output[2], v5);
    v9 = _mm256_load_si256((const __m256i*)&output[1]);
    v11 = ((arg & 2) != 0) ? one : zero;
...
"##
    ...
    v0 = _mm_and_ps(v0, v1);
    v1 = _mm_load_ps((const float*)&input[2]);
    v2 = _mm_load_ps((const float*)&input[3]);
    v1 = _mm_andnot_ps(v2, v1);
    v2 = _mm_load_ps((const float*)&input[4]);
    v3 = _mm_load_ps((const float*)&input[5]);
    v2 = _mm_xor_ps(v2, v3);
...
"##
    ...
    v0 = _mm256_and_ps(v0, v1);
    _mm256_store_ps((float*)&output[0], v0);
    _mm256_store_ps((float*)&output[4], _mm256_xor_ps(v0, one));
    _mm256_store_ps((float*)&output[8], v0);
    _mm256_store_ps((float*)&output[12], _mm256_xor_ps(v0, one));
    _mm256_store_ps((float*)&output[16], v0);
    _mm256_store_ps((float*)&output[20], _mm256_xor_ps(v0, one));
    v1 = _mm256_load_ps((const float*)&input[2]);
    v2 = _mm256_load_ps((const float*)&input[3]);
    v1 = _mm256_andnot_ps(v2, v1);
    _mm256_store_ps((float*)&output[1], _mm256_xor_ps(v1, one));
    _mm256_store_ps((float*)&output[5], v1);
    _mm256_store_ps((float*)&output[9], _mm256_xor_ps(v1, one));
    _mm256_store_ps((float*)&output[13], v1);
    _mm256_store_ps((float*)&output[17], _mm256_xor_ps(v1, one));
    _mm256_store_ps((float*)&output[21], v1);
    v2 = _mm256_load_ps((const float*)&input[4]);
    v3 = _mm256_load_ps((const float*)&input[5]);
    v2 = _mm256_xor_ps(v2, v3);
    _mm256_store_ps((float*)&output[2], _mm256_xor_ps(v2, one));
    _mm256_store_ps((float*)&output[6], v2);
    _mm256_store_ps((float*)&output[10], _mm256_xor_ps(v2, one));
    _mm256_store_ps((float*)&output[14], v2);
    _mm256_store_ps((float*)&output[18], _mm256_xor_ps(v2, one));
    _mm256_store_ps((float*)&output[22], v2);
    v3 = _mm256_load_ps((const float*)&input[6]);
    v4 = _mm256_load_ps((const float*)&input[7]);
    v3 = _mm256_or_ps(v3, v4);
    _mm256_store_ps((float*)&output[3], v3);
    _mm256_store_ps((float*)&output[7], _mm256_xor_ps(v3, one));
    _mm256_store_ps((float*)&output[11], v3);
    _mm256_store_ps((float*)&output[15], _mm256_xor_ps(v3, one));
    _mm256_store_ps((float*)&output[19], v3);
    _mm256_store_ps((float*)&output[23], _mm256_xor_ps(v3, one));
...
"##
    ...
    _mm_store_si128((__m128i*)&output[4], _mm_xor_si128(v0, one));
    _mm_store_si128((__m128i*)&output[8], v0);
    _mm_store_si128((__m128i*)&output[12], _mm_xor_si128(v0, one));
    _mm_store_si128((__m128i*)&output[16], v0);
    _mm_store_si128((__m128i*)&output[20], _mm_xor_si128(v0, one));
    v1 = _mm_load_si128((const __m128i*)&input[2]);
    v2 = _mm_load_si128((const __m128i*)&input[3]);
    v1 = _mm_andnot_si128(v2, v1);
    _mm_store_si128((__m128i*)&output[1], _mm_xor_si128(v1, one));
    _mm_store_si128((__m128i*)&output[5], v1);
    _mm_store_si128((__m128i*)&output[9], _mm_xor_si128(v1, one));
    _mm_store_si128((__m128i*)&output[13], v1);
    _mm_store_si128((__m128i*)&output[17], _mm_xor_si128(v1, one));
    _mm_store_si128((__m128i*)&output[21], v1);
    v2 = _mm_load_si128((const __m128i*)&input[4]);
    v3 = _mm_load_si128((const __m128i*)&input[5]);
    v2 = _mm_xor_si128(v2, v3);
    _mm_store_si128((__m128i*)&output[2], _mm_xor_si128(v2, one));
    _mm_store_si128((__m128i*)&output[6], v2);
    _mm_store_si128((__m128i*)&output[10], _mm_xor_si128(v2, one));
    _mm_store_si128((__m128i*)&output[14], v2);
    _mm_store_si128((__m128i*)&output[18], _mm_xor_si128(v2, one));
    _mm_store_si128((__m128i*)&output[22], v2);
    v3 = _mm_load_si128((const __m128i*)&input[6]);
    v4 = _mm_load_si128((const __m128i*)&input[7]);
    v3 = _mm_or_si128(v3, v4);
    _mm_store_si128((__m128i*)&output[3], v3);
    _mm_store_si128((__m128i*)&output[7], _mm_xor_si128(v3, one));
    _mm_store_si128((__m128i*)&output[11], v3);
    _mm_store_si128((__m128i*)&output[15], _mm_xor_si128(v3, one));
    _mm_store_si128((__m128i*)&output[19], v3);
    _mm_store_si128((__m128i*)&output[23], _mm_xor_si128(v3, one));
