...
#undef i13
    ...
    v6 = _mm_xor_ps(v4, v5);
    _mm_storeu_ps((float*)&output[0], v6);
    v6 = elem_low_bit1;
    v7 = elem_low_bit2;
    v8 = _mm_xor_ps(v6, v7);
    v4 = _mm_and_ps(v4, v5);
    ...
    v5 = _mm_loadu_ps((const float*)&input[0]);
    v9 = elem_low_bit3;
    ...
    _mm_storeu_ps((float*)&output[2], v6);
    v6 = _mm_loadu_ps((const float*)&input[1]);
    ...
    v4 = _mm_loadu_ps((const float*)&input[6]);
    v5 = _mm_xor_ps(v0, v4);
    v2 = _mm_or_ps(v7, v2);
...
#undef i13
    v4 = elem_low_bit0;
    v5 = _mm256_loadu_ps((const float*)&input[1]);
    v6 = _mm256_xor_ps(v4, v5);
    _mm256_storeu_ps((float*)&output[0], v6);
    v6 = elem_low_bit1;
    v7 = elem_low_bit2;
    v8 = _mm256_xor_ps(v6, v7);
    v4 = _mm256_and_ps(v4, v5);
    v5 = _mm256_xor_ps(v8, v4);
    _mm256_storeu_ps((float*)&output[1], v5);
    v5 = _mm256_loadu_ps((const float*)&input[3]);
    v9 = elem_low_bit3;
    ...
    _mm256_storeu_ps((float*)&output[2], v6);
    v6 = _mm256_loadu_ps((const float*)&input[4]);
    v7 = _mm256_loadu_ps((const float*)&input[0]);
    v6 = _mm256_xor_ps(v6, v7);
    v4 = _mm256_and_ps(v10, v4);
    v5 = _mm256_and_ps(v5, v9);
    v4 = _mm256_or_ps(v4, v5);
    v4 = _mm256_xor_ps(v6, v4);
    _mm256_storeu_ps((float*)&output[3], v4);
    v4 = _mm256_loadu_ps((const float*)&input[5]);
    v5 = _mm256_xor_ps(v4, v2);
    _mm256_storeu_ps((float*)&output[4], v5);
    v6 = _mm256_loadu_ps((const float*)&input[6]);
    ...
    v3 = _mm256_loadu_ps((const float*)&input[2]);
...
#undef i13
    ...
    v7 = _mm_loadu_si128((const __m128i*)&output[0]);
    _mm_storeu_si128((__m128i*)&output[0], v6);
    v6 = elem_low_bit1;
    v8 = elem_low_bit2;
    v9 = _mm_xor_si128(v6, v8);
    v4 = _mm_and_si128(v4, v5);
    v5 = _mm_xor_si128(v9, v4);
    _mm_storeu_si128((__m128i*)&output[1], v5);
    v5 = _mm_loadu_si128((const __m128i*)&output[3]);
    v10 = elem_low_bit3;
    ...
    v8 = _mm_loadu_si128((const __m128i*)&output[2]);
    _mm_storeu_si128((__m128i*)&output[2], v6);
    v6 = _mm_loadu_si128((const __m128i*)&output[4]);
    v6 = _mm_xor_si128(v6, v7);
    v4 = _mm_and_si128(v11, v4);
    v5 = _mm_and_si128(v5, v10);
    v4 = _mm_or_si128(v4, v5);
    v4 = _mm_xor_si128(v6, v4);
    _mm_storeu_si128((__m128i*)&output[3], v4);
    v4 = _mm_loadu_si128((const __m128i*)&output[5]);
    v5 = _mm_xor_si128(v4, v2);
    _mm_storeu_si128((__m128i*)&output[4], v5);
    v6 = _mm_loadu_si128((const __m128i*)&output[6]);
