...
void gate_sys_blab(const gate_sys_type* input,
    ...
    gate_sys_type v3;
    gate_sys_type v4;
    v0.array[0] = _mm256_loadu_si256((const float*)&(input[0].array[0]));
    v0.array[1] = _mm256_loadu_si256((const float*)&(input[0].array[1]));
    v0.array[2] = _mm256_loadu_si256((const float*)&(input[0].array[2]));
    v0.array[3] = _mm256_loadu_si256((const float*)&(input[0].array[3]));
    v1.array[0] = _mm256_loadu_si256((const float*)&(input[1].array[0]));
    v1.array[1] = _mm256_loadu_si256((const float*)&(input[1].array[1]));
    v1.array[2] = _mm256_loadu_si256((const float*)&(input[1].array[2]));
    v1.array[3] = _mm256_loadu_si256((const float*)&(input[1].array[3]));
    ...
    v3.array[0] = _mm256_loadu_si256((const float*)&(input[2].array[0]));
    v3.array[1] = _mm256_loadu_si256((const float*)&(input[2].array[1]));
    v3.array[2] = _mm256_loadu_si256((const float*)&(input[2].array[2]));
    v3.array[3] = _mm256_loadu_si256((const float*)&(input[2].array[3]));
    ...
    _mm256_storeu_si256((float*)&(output[0].array[0]), v4.array[0]);
    _mm256_storeu_si256((float*)&(output[0].array[1]), v4.array[1]);
    _mm256_storeu_si256((float*)&(output[0].array[2]), v4.array[2]);
    _mm256_storeu_si256((float*)&(output[0].array[3]), v4.array[3]);
    ...
    _mm256_storeu_si256((float*)&(output[1].array[0]), v0.array[0]);
    _mm256_storeu_si256((float*)&(output[1].array[1]), v0.array[1]);
    _mm256_storeu_si256((float*)&(output[1].array[2]), v0.array[2]);
    _mm256_storeu_si256((float*)&(output[1].array[3]), v0.array[3]);
}
"##
    );
}
