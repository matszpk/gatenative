...
void gate_sys_blab(const gate_sys_type* input,
    ...
    const unsigned int idxl0 = (idx + 0) & 0xffffffff;
    const unsigned int idxh0 = (idx + 0) >> 32;
    const unsigned int idxl1 = (idx + 1) & 0xffffffff;
    const unsigned int idxh1 = (idx + 1) >> 32;
    const unsigned int idxl2 = (idx + 2) & 0xffffffff;
    const unsigned int idxh2 = (idx + 2) >> 32;
    const unsigned int idxl3 = (idx + 3) & 0xffffffff;
    const unsigned int idxh3 = (idx + 3) >> 32;
    gate_sys_type v0;
    gate_sys_type v1;
    gate_sys_type v2;
    gate_sys_type v3;
