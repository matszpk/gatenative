...
void gate_sys_blab(const gate_sys_type* input,
    ...
    gate_sys_type v3;
    gate_sys_type v4;
    v0.array[0] = _mm256_load_si256((const __m256i*)&(input[0].array[0]));
    v0.array[1] = _mm256_load_si256((const __m256i*)&(input[0].array[1]));
    v0.array[2] = _mm256_load_si256((const __m256i*)&(input[0].array[2]));
    v0.array[3] = _mm256_load_si256((const __m256i*)&(input[0].array[3]));
    v1.array[0] = _mm256_load_si256((const __m256i*)&(input[1].array[0]));
    v1.array[1] = _mm256_load_si256((const __m256i*)&(input[1].array[1]));
    v1.array[2] = _mm256_load_si256((const __m256i*)&(input[1].array[2]));
    v1.array[3] = _mm256_load_si256((const __m256i*)&(input[1].array[3]));
    ...
    v3.array[0] = _mm256_load_si256((const __m256i*)&(input[2].array[0]));
    v3.array[1] = _mm256_load_si256((const __m256i*)&(input[2].array[1]));
    v3.array[2] = _mm256_load_si256((const __m256i*)&(input[2].array[2]));
    v3.array[3] = _mm256_load_si256((const __m256i*)&(input[2].array[3]));
    ...
    _mm256_store_si256((__m256i*)&(output[0].array[0]), v4.array[0]);
    _mm256_store_si256((__m256i*)&(output[0].array[1]), v4.array[1]);
    _mm256_store_si256((__m256i*)&(output[0].array[2]), v4.array[2]);
    _mm256_store_si256((__m256i*)&(output[0].array[3]), v4.array[3]);
    ...
    _mm256_store_si256((__m256i*)&(output[1].array[0]), v0.array[0]);
    _mm256_store_si256((__m256i*)&(output[1].array[1]), v0.array[1]);
    _mm256_store_si256((__m256i*)&(output[1].array[2]), v0.array[2]);
    _mm256_store_si256((__m256i*)&(output[1].array[3]), v0.array[3]);
}
"##
    );
...
void gate_sys_blab(const gate_sys_type* input,
    ...
    v1.array[0] = _mm256_load_ps((const float*)&(input[0].array[0]));
    v1.array[1] = _mm256_load_ps((const float*)&(input[0].array[1]));
    v1.array[2] = _mm256_load_ps((const float*)&(input[0].array[2]));
    v1.array[3] = _mm256_load_ps((const float*)&(input[0].array[3]));
    v2.array[0] = _mm256_load_ps((const float*)&(input[1].array[0]));
    v2.array[1] = _mm256_load_ps((const float*)&(input[1].array[1]));
    v2.array[2] = _mm256_load_ps((const float*)&(input[1].array[2]));
    v2.array[3] = _mm256_load_ps((const float*)&(input[1].array[3]));
    ...
    _mm256_store_ps((float*)&(output[0].array[0]), v0.array[0]);
    _mm256_store_ps((float*)&(output[0].array[1]), v0.array[1]);
    _mm256_store_ps((float*)&(output[0].array[2]), v0.array[2]);
    _mm256_store_ps((float*)&(output[0].array[3]), v0.array[3]);
    v0.array[0] = _mm256_load_ps((const float*)&(input[2].array[0]));
    v0.array[1] = _mm256_load_ps((const float*)&(input[2].array[1]));
    v0.array[2] = _mm256_load_ps((const float*)&(input[2].array[2]));
    v0.array[3] = _mm256_load_ps((const float*)&(input[2].array[3]));
    v1.array[0] = _mm256_load_ps((const float*)&(input[3].array[0]));
    v1.array[1] = _mm256_load_ps((const float*)&(input[3].array[1]));
    v1.array[2] = _mm256_load_ps((const float*)&(input[3].array[2]));
    v1.array[3] = _mm256_load_ps((const float*)&(input[3].array[3]));
    ...
    v0.array[2] = _mm256_xor_ps(v0.array[2], v1.array[2]);
    v0.array[3] = _mm256_xor_ps(v0.array[3], v1.array[3]);
    _mm256_store_ps((float*)&(output[1].array[0]), _mm256_xor_ps(v0.array[0], one));
    _mm256_store_ps((float*)&(output[1].array[1]), _mm256_xor_ps(v0.array[1], one));
    _mm256_store_ps((float*)&(output[1].array[2]), _mm256_xor_ps(v0.array[2], one));
    _mm256_store_ps((float*)&(output[1].array[3]), _mm256_xor_ps(v0.array[3], one));
}
"##
    );
...
void gate_sys_blab(const gate_sys_type* input,
    ...
    v0.array[2] = elem_low_bit0;
    v0.array[3] = elem_low_bit0;
    v1.array[0] = _mm256_load_si256((const __m256i*)&(input[0].array[0]));
    v1.array[1] = _mm256_load_si256((const __m256i*)&(input[0].array[1]));
    v1.array[2] = _mm256_load_si256((const __m256i*)&(input[0].array[2]));
    v1.array[3] = _mm256_load_si256((const __m256i*)&(input[0].array[3]));
    ...
    v1.array[2] = elem_low_bit1;
    v1.array[3] = elem_low_bit1;
    v2.array[0] = _mm256_load_si256((const __m256i*)&(input[1].array[0]));
    v2.array[1] = _mm256_load_si256((const __m256i*)&(input[1].array[1]));
    v2.array[2] = _mm256_load_si256((const __m256i*)&(input[1].array[2]));
    v2.array[3] = _mm256_load_si256((const __m256i*)&(input[1].array[3]));
    ...
    v1.array[2] = elem_low_bit2;
    v1.array[3] = elem_low_bit2;
    v2.array[0] = _mm256_load_si256((const __m256i*)&(input[2].array[0]));
    v2.array[1] = _mm256_load_si256((const __m256i*)&(input[2].array[1]));
    v2.array[2] = _mm256_load_si256((const __m256i*)&(input[2].array[2]));
    v2.array[3] = _mm256_load_si256((const __m256i*)&(input[2].array[3]));
    ...
    v2.array[2] = elem_low_bit3;
    v2.array[3] = elem_low_bit3;
    v3.array[0] = _mm256_load_si256((const __m256i*)&(input[3].array[0]));
    v3.array[1] = _mm256_load_si256((const __m256i*)&(input[3].array[1]));
    v3.array[2] = _mm256_load_si256((const __m256i*)&(input[3].array[2]));
    v3.array[3] = _mm256_load_si256((const __m256i*)&(input[3].array[3]));
    ...
    v0.array[2] = _mm256_andnot_si256(v1.array[2], v0.array[2]);
    v0.array[3] = _mm256_andnot_si256(v1.array[3], v0.array[3]);
    _mm256_store_si256((__m256i*)&(output[0].array[0]), v0.array[0]);
    _mm256_store_si256((__m256i*)&(output[0].array[1]), v0.array[1]);
    _mm256_store_si256((__m256i*)&(output[0].array[2]), v0.array[2]);
    _mm256_store_si256((__m256i*)&(output[0].array[3]), v0.array[3]);
    v0.array[0] = elem_low_bit4;
    v0.array[1] = elem_low_bit4;
    v0.array[2] = elem_low_bit4;
    v0.array[3] = elem_low_bit4;
    ...
    v0.array[2] = _mm256_andnot_si256(v1.array[2], v0.array[2]);
    v0.array[3] = _mm256_andnot_si256(v1.array[3], v0.array[3]);
    _mm256_store_si256((__m256i*)&(output[1].array[0]), _mm256_xor_si256(v0.array[0], one));
    _mm256_store_si256((__m256i*)&(output[1].array[1]), _mm256_xor_si256(v0.array[1], one));
    _mm256_store_si256((__m256i*)&(output[1].array[2]), _mm256_xor_si256(v0.array[2], one));
    _mm256_store_si256((__m256i*)&(output[1].array[3]), _mm256_xor_si256(v0.array[3], one));
}
"##
    );
...
#undef i10
    if (iter == 0) {
    v0.array[0] = _mm_load_si128((const __m128i*)&(output[0].array[0]));
    v0.array[1] = _mm_load_si128((const __m128i*)&(output[0].array[1]));
    v0.array[2] = _mm_load_si128((const __m128i*)&(output[0].array[2]));
    v0.array[3] = _mm_load_si128((const __m128i*)&(output[0].array[3]));
    v1.array[0] = _mm_load_si128((const __m128i*)&(output[2].array[0]));
    v1.array[1] = _mm_load_si128((const __m128i*)&(output[2].array[1]));
    v1.array[2] = _mm_load_si128((const __m128i*)&(output[2].array[2]));
    v1.array[3] = _mm_load_si128((const __m128i*)&(output[2].array[3]));
    v5.array[0] = _mm_load_si128((const __m128i*)&(output[1].array[0]));
    v5.array[1] = _mm_load_si128((const __m128i*)&(output[1].array[1]));
    v5.array[2] = _mm_load_si128((const __m128i*)&(output[1].array[2]));
    v5.array[3] = _mm_load_si128((const __m128i*)&(output[1].array[3]));
    v7.array[0] = _mm_load_si128((const __m128i*)&(output[3].array[0]));
    v7.array[1] = _mm_load_si128((const __m128i*)&(output[3].array[1]));
    v7.array[2] = _mm_load_si128((const __m128i*)&(output[3].array[2]));
    v7.array[3] = _mm_load_si128((const __m128i*)&(output[3].array[3]));
    v8.array[0] = _mm_load_si128((const __m128i*)&(output[5].array[0]));
    v8.array[1] = _mm_load_si128((const __m128i*)&(output[5].array[1]));
    v8.array[2] = _mm_load_si128((const __m128i*)&(output[5].array[2]));
    v8.array[3] = _mm_load_si128((const __m128i*)&(output[5].array[3]));
    v9.array[0] = _mm_load_si128((const __m128i*)&(output[7].array[0]));
    v9.array[1] = _mm_load_si128((const __m128i*)&(output[7].array[1]));
    v9.array[2] = _mm_load_si128((const __m128i*)&(output[7].array[2]));
    v9.array[3] = _mm_load_si128((const __m128i*)&(output[7].array[3]));
    }
    ...
    _mm_store_si128((__m128i*)&(output[5].array[0]), v10.array[0]);
    _mm_store_si128((__m128i*)&(output[5].array[1]), v10.array[1]);
    _mm_store_si128((__m128i*)&(output[5].array[2]), v10.array[2]);
    _mm_store_si128((__m128i*)&(output[5].array[3]), v10.array[3]);
    ...
    _mm_store_si128((__m128i*)&(output[7].array[0]), v1.array[0]);
    _mm_store_si128((__m128i*)&(output[7].array[1]), v1.array[1]);
    _mm_store_si128((__m128i*)&(output[7].array[2]), v1.array[2]);
    _mm_store_si128((__m128i*)&(output[7].array[3]), v1.array[3]);
    ...
    _mm_store_si128((__m128i*)&(output[3].array[0]), v0.array[0]);
    _mm_store_si128((__m128i*)&(output[3].array[1]), v0.array[1]);
    _mm_store_si128((__m128i*)&(output[3].array[2]), v0.array[2]);
    _mm_store_si128((__m128i*)&(output[3].array[3]), v0.array[3]);
    v2.array[0] = elem_low_bit3;
    v2.array[1] = elem_low_bit3;
    v2.array[2] = elem_low_bit3;
    v2.array[3] = elem_low_bit3;
    ...
    _mm_store_si128((__m128i*)&(output[2].array[0]), v4.array[0]);
    _mm_store_si128((__m128i*)&(output[2].array[1]), v4.array[1]);
    _mm_store_si128((__m128i*)&(output[2].array[2]), v4.array[2]);
    _mm_store_si128((__m128i*)&(output[2].array[3]), v4.array[3]);
    ...
    _mm_store_si128((__m128i*)&(output[0].array[0]), v5.array[0]);
    _mm_store_si128((__m128i*)&(output[0].array[1]), v5.array[1]);
    _mm_store_si128((__m128i*)&(output[0].array[2]), v5.array[2]);
    _mm_store_si128((__m128i*)&(output[0].array[3]), v5.array[3]);
    ...
    _mm_store_si128((__m128i*)&(output[1].array[0]), v2.array[0]);
    _mm_store_si128((__m128i*)&(output[1].array[1]), v2.array[1]);
    _mm_store_si128((__m128i*)&(output[1].array[2]), v2.array[2]);
    _mm_store_si128((__m128i*)&(output[1].array[3]), v2.array[3]);
#define o0 (v11)
#define o2 (v1)
#define o3 (v0)
#define o5 (v3)
