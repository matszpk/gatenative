...
"##
    ...
    v0 = elem_low_bit0;
    v1 = _mm_load_ps((const float*)&input[3]);
    v0 = _mm_xor_ps(v0, v1);
    ...
    v0 = elem_low_bit2;
    v1 = _mm_load_ps((const float*)&input[5]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[3], v0);
    v0 = elem_low_bit3;
    v1 = _mm_load_ps((const float*)&input[6]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[4], v0);
    v0 = elem_low_bit4;
    v1 = _mm_load_ps((const float*)&input[7]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[5], v0);
    v0 = elem_low_bit5;
    v1 = _mm_load_ps((const float*)&input[8]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[6], v0);
    v0 = elem_low_bit6;
    v1 = _mm_load_ps((const float*)&input[9]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[7], v0);
    v0 = ((idxl & 1) != 0) ? one : zero;
    v1 = _mm_load_ps((const float*)&input[10]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[8], v0);
    v0 = ((idxl & 2) != 0) ? one : zero;
    v1 = _mm_load_ps((const float*)&input[11]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[9], v0);
    v0 = ((idxl & 4) != 0) ? one : zero;
    v1 = _mm_load_ps((const float*)&input[12]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[10], v0);
    v0 = ((idxl & 8) != 0) ? one : zero;
    v1 = _mm_load_ps((const float*)&input[13]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[11], v0);
    v0 = ((idxl & 16) != 0) ? one : zero;
    v1 = _mm_load_ps((const float*)&input[14]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[12], v0);
    v0 = ((idxl & 32) != 0) ? one : zero;
    v1 = _mm_load_ps((const float*)&input[15]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[13], v0);
    v0 = _mm_load_ps((const float*)&input[1]);
    v1 = _mm_load_ps((const float*)&input[16]);
    v0 = _mm_xor_ps(v0, v1);
    _mm_store_ps((float*)&output[14], v0);
}
"##
    );
    ...
    v0 = elem_low_bit0;
    v1 = _mm256_load_ps((const float*)&input[3]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[1], v0);
    v0 = elem_low_bit1;
    v1 = _mm256_load_ps((const float*)&input[4]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[2], v0);
    v0 = elem_low_bit2;
    v1 = _mm256_load_ps((const float*)&input[5]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[3], v0);
    v0 = elem_low_bit3;
    v1 = _mm256_load_ps((const float*)&input[6]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[4], v0);
    v0 = elem_low_bit4;
    v1 = _mm256_load_ps((const float*)&input[7]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[5], v0);
    v0 = elem_low_bit5;
    v1 = _mm256_load_ps((const float*)&input[8]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[6], v0);
    v0 = elem_low_bit6;
    v1 = _mm256_load_ps((const float*)&input[9]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[7], v0);
    v0 = elem_low_bit7;
    v1 = _mm256_load_ps((const float*)&input[10]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[8], v0);
    v0 = ((idxl & 1) != 0) ? one : zero;
    v1 = _mm256_load_ps((const float*)&input[11]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[9], v0);
    v0 = ((idxl & 2) != 0) ? one : zero;
    v1 = _mm256_load_ps((const float*)&input[12]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[10], v0);
    v0 = ((idxl & 4) != 0) ? one : zero;
    v1 = _mm256_load_ps((const float*)&input[13]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[11], v0);
    v0 = ((idxl & 8) != 0) ? one : zero;
    v1 = _mm256_load_ps((const float*)&input[14]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[12], v0);
    v0 = ((idxl & 16) != 0) ? one : zero;
    v1 = _mm256_load_ps((const float*)&input[15]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[13], v0);
    v0 = _mm256_load_ps((const float*)&input[1]);
    v1 = _mm256_load_ps((const float*)&input[16]);
    v0 = _mm256_xor_ps(v0, v1);
    _mm256_store_ps((float*)&output[14], v0);
}
"##
    );
    ...
    __m512i v0;
    __m512i v1;
    v0 = _mm512_load_epi64(&input[0]);
    v1 = _mm512_load_epi64(&input[2]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[0], v0);
    v0 = elem_low_bit0;
    v1 = _mm512_load_epi64(&input[3]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[1], v0);
    v0 = elem_low_bit1;
    v1 = _mm512_load_epi64(&input[4]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[2], v0);
    v0 = elem_low_bit2;
    v1 = _mm512_load_epi64(&input[5]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[3], v0);
    v0 = elem_low_bit3;
    v1 = _mm512_load_epi64(&input[6]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[4], v0);
    v0 = elem_low_bit4;
    v1 = _mm512_load_epi64(&input[7]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[5], v0);
    v0 = elem_low_bit5;
    v1 = _mm512_load_epi64(&input[8]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[6], v0);
    v0 = elem_low_bit6;
    v1 = _mm512_load_epi64(&input[9]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[7], v0);
    v0 = elem_low_bit7;
    v1 = _mm512_load_epi64(&input[10]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[8], v0);
    v0 = elem_low_bit8;
    v1 = _mm512_load_epi64(&input[11]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[9], v0);
    v0 = ((idxl & 1) != 0) ? one : zero;
    v1 = _mm512_load_epi64(&input[12]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[10], v0);
    v0 = ((idxl & 2) != 0) ? one : zero;
    v1 = _mm512_load_epi64(&input[13]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[11], v0);
    v0 = ((idxl & 4) != 0) ? one : zero;
    v1 = _mm512_load_epi64(&input[14]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[12], v0);
    v0 = ((idxl & 8) != 0) ? one : zero;
    v1 = _mm512_load_epi64(&input[15]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[13], v0);
    v0 = _mm512_load_epi64(&input[1]);
    v1 = _mm512_load_epi64(&input[16]);
    v0 = _mm512_xor_epi64(v0, v1);
    _mm512_store_epi64(&output[14], v0);
}
"##
    );
